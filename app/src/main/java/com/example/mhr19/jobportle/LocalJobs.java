...
public class LocalJobs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.activity_local_jobs,container,false);
        SetList(view);
        return  view;
    }
    ...
    {
        list = (ListView)view.findViewById(R.id.local_jobs_list);
